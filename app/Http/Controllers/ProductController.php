...
GET['dir'] ?? 'desc';
        ...
        // Using raw PDO to keep the framework extremely lightweight
...
SERVER['REQUEST_URI'] ?? '/';
        $publicRoutes = ['/products', '/products/show'];
        if (!isset(<?php
namespace App\Http\Controllers;
...
SESSION['user_id']) && strpos($uri, '/create') !== false || strpos($uri, '/edit') !== false || <?php
namespace App\Http\Controllers;
